...
if(isset($_POST['submit'])){
    ...
    $_SESSION['success'] = 'Task Updated Correctly';
...
<main>  
    ...
    <section>
            ...
            value="<?php echo $user->Start; ?>">

            <strong>Description:</strong><textarea type="text" name="Description"  class="form-control" 
            value="<?php echo $user->Description; ?>"></textarea>
        
            
            <strong>Status:</strong><select  name="Status" value="<?php echo $user->Status; ?>" >
